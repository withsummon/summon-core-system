...
export const SummonSettingsRootView: React.FC<ISummonSettingsRootViewProps> = observer(function SummonSettingsRootView({
  workspaceSlug,
  workspaceName,
}) {
      ...
      <div className="mx-auto w-full max-w-[1600px] space-y-5 p-5 md:p-6 lg:p-7">
        ...
        <div className="grid grid-cols-1 items-start gap-5 lg:grid-cols-12">
          ...
          <div className="lg:col-span-3 xl:col-span-2">
            <SettingsSidebarNav activeSection={activeSection} onSelectSection={handleSelectSection} />
          </div>
          ...
          <div className="space-y-4 lg:col-span-3 xl:col-span-3">
            ...
            />
            <PlanCard />
            <IntegrationsCard onManageIntegrations={() => setActiveSection("integrations")} />
            <SecuritySummaryCard onManageSecurity={() => setActiveSection("security")} />
          </div>
        </div>
      </div>
    </div>
