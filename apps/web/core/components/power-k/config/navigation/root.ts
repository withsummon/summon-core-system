...
export const usePowerKNavigationCommands = (): TPowerKCommandConfig[] => {
  ...
  return [
    ...
    optionsList["nav_summon_home"],
    optionsList["nav_summon_projects"],
    optionsList["nav_summon_clients"],
    optionsList["nav_summon_opportunities"],
    optionsList["nav_summon_tasks"],
    optionsList["nav_summon_documents"],
    optionsList["nav_summon_knowledge"],
    optionsList["nav_summon_reports"],
    optionsList["nav_summon_resources"],
    optionsList["nav_summon_meetings"],
    optionsList["nav_summon_automation"],
    optionsList["nav_summon_assistant"],
    optionsList["nav_summon_credentials"],
    optionsList["nav_summon_notifications"],
    optionsList["nav_summon_settings"],
