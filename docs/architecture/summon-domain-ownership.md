...
| Summon assistant                                                                     | plane.summon    | Owner-scoped conversations and append-only messages over explicit authorized context |
...
| Model                 | Owner        |
| --------------------- | ------------ |
| AssistantConversation | plane.summon |
| AssistantMessage      | plane.summon |
| Client                | plane.summon |
